...
function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_kjdnx5m", "template_em0vz6s", form.current, {
        publicKey: "9Uq8LLY5phqrwXwD7",
      })
      .then(
        () => {
          console.log("SUCCESS!");
    ...
    <section id="contact">
      <div id="social">
        ...
        <div className="siocialImgs">
          <a href="www.https://www.linkedin.com/in/happy-fulwani-264b60251/">
            <img src={LinkedIn} alt="LinkedIn" className="socialImg" />
          </a>
          <a href="https://github.com/Happy-fulwani">
            <img src={Github} alt="Github" className="socialImg" />
          </a>
          <a href="https://www.instagram.com/its_happy_fulwani/?next=%2F&hl=en">
